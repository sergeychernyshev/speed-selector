...
${TEST_FOLDER}/video.mp4: ${FRAMES_FOLDER}/${FRAME_FILE}
	php avs_to_mp4.php ${AVS} ${FRAMES_FOLDER} ${TEST_FOLDER}/video.mp4

${TEST_FOLDER}/diff_video.mp4: ${TEST_FOLDER}/video.mp4
	mkdir -p ${DIFFS_FOLDER}
	php frame_diff.php ${AVS} ${FRAMES_FOLDER} ${DIFFS_FOLDER}
	php avs_to_mp4.php ${AVS} ${DIFFS_FOLDER} ${TEST_FOLDER}/diff_video.mp4
...
${TEST_FOLDER}/diff_overlay_video.mp4: ${TEST_FOLDER}/diff_video.mp4
	...
	php avs_to_mp4.php ${AVS} ${OVERLAY_FOLDER} ${TEST_FOLDER}/diff_overlay_video.mp4
...
${TEST_FOLDER}/masked.mp4: ${MASK} ${TEST_FOLDER}/video.mp4
...
${TEST_FOLDER}/masked_diff_video.mp4: ${TEST_FOLDER}/masked.mp4
	mkdir -p ${MASKED_DIFF_FOLDER}
	php frame_diff.php ${AVS} ${MASKED_FOLDER} ${MASKED_DIFF_FOLDER}
	php avs_to_mp4.php ${AVS} ${MASKED_DIFF_FOLDER} ${TEST_FOLDER}/masked_diff_video.mp4

${TEST_FOLDER}/masked_diff_overlay_video.mp4: ${TEST_FOLDER}/masked_diff_video.mp4
	mkdir -p ${MASKED_OVERLAY_FOLDER}
	php diff_overlay.php ${AVS} ${MASKED_FOLDER} ${MASKED_DIFF_FOLDER} ${MASKED_OVERLAY_FOLDER}
	php avs_to_mp4.php ${AVS} ${MASKED_OVERLAY_FOLDER} ${TEST_FOLDER}/masked_diff_overlay_video.mp4
